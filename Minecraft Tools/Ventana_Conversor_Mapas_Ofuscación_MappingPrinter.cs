...
{
    /// <summary>
    /// Class that includes some parts of the sourcer of ProGuard to learn how it saves maps.
    /// </summary>
    internal static class Ventana_Conversor_Mapas_Ofuscación_MappingPrinter
    {
        /*
