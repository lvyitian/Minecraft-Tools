...
{
    /// <summary>
    /// This custom RegionFile class will only open a Minecraft world under read-only and will never change any of it's original files, but note that the original Substrate code might do it without warning you first, so be aware of that or you might loose your worlds, to avoid it please make backups first. Also this class is designed to work with 1.12.2- but also with 1.13+ worlds.
    /// </summary>
