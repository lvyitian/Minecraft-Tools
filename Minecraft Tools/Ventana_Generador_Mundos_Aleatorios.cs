            ...
            try
            {
                ...
                for (int Índice_Z = 0; Índice_Z < Variable_Dimensiones_X; Índice_Z++)
                {
                    for (int Índice_X = 0; Índice_X < Variable_Dimensiones_X; Índice_X++)
                    {
                        int Total = 0;
                        int Divisores = 0;
                        int Rango = 1; // 1. // 3. // 5. // Higher values are a lot slower.
                ...
                // Start all the chunks and set the correct biomes for all of them.
                ...
                // Then add the different layers based on the biome.
                for (int Índice_Z = 0; Índice_Z < Variable_Dimensiones_X; Índice_Z++)
                {
                    for (int Índice_X = 0; Índice_X < Variable_Dimensiones_X; Índice_X++)
                    {
