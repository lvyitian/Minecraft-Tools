...
{
    public class Multimedia_Player
    {
        ...
        public Multimedia_Player(List<string> Lista_Rutas)
        {
        ...
        public void Obtener_Posibles_Errores()
        {
            if (error != 0)
            {
                ...
                {
                    Depurador.Escribir_Excepción("[winmm.dll] Multimedia_Player: " + Mensaje);
                    //Ventana_Reproductor_Multimedia.Escribir_Excepción("[winmm.dll] " + Mensaje);
                }
            }
        }
    }
